...
import KYCQuestionsPage from './components/pages/KYCQuestionsPage';
  ...
  renderPage() {
    return (
        <Switch>
          ...
          <Route path="/kyc-questions/:id" component={KYCQuestionsPage} />
          <Route path="/kyc-questions" render={({history}) => {
            history.push({
              pathname: '/kyc-questions/first-question',
              search: history.location.search
            }); return null;}} />
